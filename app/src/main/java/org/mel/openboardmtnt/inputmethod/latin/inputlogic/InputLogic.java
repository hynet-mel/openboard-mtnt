...
package org.mel.openboardmtnt.inputmethod.latin.inputlogic;
...
import org.mel.openboardmtnt.inputmethod.compat.SuggestionSpanUtils;
...
import org.mel.openboardmtnt.inputmethod.latin.Dictionary;
import org.mel.openboardmtnt.inputmethod.latin.DictionaryFacilitator;
import org.mel.openboardmtnt.inputmethod.latin.LastComposedWord;
import org.mel.openboardmtnt.inputmethod.latin.LatinIME;
import org.mel.openboardmtnt.inputmethod.latin.NgramContext;
import org.mel.openboardmtnt.inputmethod.latin.RichInputConnection;
import org.mel.openboardmtnt.inputmethod.latin.Suggest;
import org.mel.openboardmtnt.inputmethod.latin.Suggest.OnGetSuggestedWordsCallback;
import org.mel.openboardmtnt.inputmethod.latin.SuggestedWords;
import org.mel.openboardmtnt.inputmethod.latin.SuggestedWords.SuggestedWordInfo;
import org.mel.openboardmtnt.inputmethod.latin.WordComposer;
...
import org.mel.openboardmtnt.inputmethod.latin.common.StringUtils;
...
import org.mel.openboardmtnt.inputmethod.latin.settings.SettingsValuesForSuggestion;
import org.mel.openboardmtnt.inputmethod.latin.settings.SpacingAndPunctuations;
import org.mel.openboardmtnt.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import org.mel.openboardmtnt.inputmethod.latin.utils.AsyncResultHolder;
import org.mel.openboardmtnt.inputmethod.latin.utils.InputTypeUtils;
import org.mel.openboardmtnt.inputmethod.latin.utils.RecapitalizeStatus;
import org.mel.openboardmtnt.inputmethod.latin.utils.StatsUtils;
import org.mel.openboardmtnt.inputmethod.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link org.mel.openboardmtnt.inputmethod.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link org.mel.openboardmtnt.inputmethod.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link org.mel.openboardmtnt.inputmethod.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, org.mel.openboardmtnt.inputmethod.latin.SuggestedWords)}.
