...
static const JNINativeMethod sMethods[] = {
    ...
    },
    {
        ...
        const_cast<char *>(
                "(J[Lorg/mel/openboardmtnt/inputmethod/latin/utils/WordInputEventForPersonalization;I)I"),
...
int register_BinaryDictionary(JNIEnv *env) {
    const char *const kClassPathName = "org/mel/openboardmtnt/inputmethod/latin/BinaryDictionary";
